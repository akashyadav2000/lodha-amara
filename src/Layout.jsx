...
function Layout() {
  ...
  const handleFormSubmit = () => {
    setIsModalOpen(false); // ✅ Also close popup after submit
    ...
    <div className="relative min-h-screen">
      ...
      <div className="flex flex-col mt-14 lg:flex-row">
        <div className="w-full lg:w-[77.55%]">
          ...
          {showThankYou && (
            <div className="fixed inset-0 w-full lg:w-[77.55%] z-40 flex items-center justify-center min-h-screen bg-white p-4">
              <ThankYou />
            </div>
          )}
      ...
      <PopUp
        ...
        enquiryType={enquiryType}
        onFormSubmit={handleFormSubmit} // ✅ PASS IT HERE
      />
    </div>
  );
}
